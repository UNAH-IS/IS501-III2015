...
---Mostrar la jerarquia de la tripulacion en 3 niveles.
SELECT A.NOMBRE, 
      B.NOMBRE AS NOMBRE_SUPERIOR_1,
      C.NOMBRE AS NOMBRE_SUPERIOR_2
FROM TBL_TRIPULACION A
LEFT JOIN TBL_TRIPULACION B
ON (A.CODIGO_TRIPULANTE_SUPERIOR = B.CODIGO_TRIPULANTE)
LEFT JOIN TBL_TRIPULACION C
ON (B.CODIGO_TRIPULANTE_SUPERIOR = C.CODIGO_TRIPULANTE);